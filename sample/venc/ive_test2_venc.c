    ...
    //    printf("HI_MPI_VI_GetFrameTimeOut success!\n");
     ...
     //   printf("HI_MPI_SYS_MmzAlloc_Cached\n");
      ...
      //  printf("HI_MPI_IVE_FILTER\n");
        ...
        // stThreshFrameInfo.stVFrame.u32Stride[1] = 0;
        stThreshFrameInfo.stVFrame.u32Stride[2] = 0;
        stThreshFrameInfo.stVFrame.u32TimeRef = stViFrameInfo.stVFrame.u32TimeRef;
        stThreshFrameInfo.stVFrame.u64pts = stViFrameInfo.stVFrame.u64pts;
        ...
        stThreshFrameInfo.stVFrame.u32PhyAddr[1] = stThreshFrameInfo.stVFrame.u32PhyAddr[0] + u32Stride * u32Height;
        ...
        // stThreshFrameInfo.stVFrame.pVirAddr[1] = HI_NULL;
        ...
        */
        ...
        memset(stThreshFrameInfo.stVFrame.pVirAddr[1], 0, u32Stride * u32Height );
...
#endif
#if 0
          printf("stViFrameInfo.stVFrame.u32Field = %d\n",stViFrameInfo.stVFrame.u32Field);
          printf("stViFrameInfo.stVFrame.enPixelFormat = %d\n",stViFrameInfo.stVFrame.enPixelFormat);
          printf("stViFrameInfo.stVFrame.u32Height = %d\n",stViFrameInfo.stVFrame.u32Height);
          printf("stViFrameInfo.stVFrame.u32Width  = %d\n",stViFrameInfo.stVFrame.u32Width);
          printf("stViFrameInfo.stVFrame.u32Stride[0] = %d\n",stViFrameInfo.stVFrame.u32Stride[0]);
          printf("stViFrameInfo.stVFrame.u32Stride[1] = %d\n",stViFrameInfo.stVFrame.u32Stride[1]);
          printf("stViFrameInfo.stVFrame.u32Stride[2] = %d\n",stViFrameInfo.stVFrame.u32Stride[2]);
          printf("stViFrameInfo.stVFrame.u32TimeRef = %d\n",stViFrameInfo.stVFrame.u32TimeRef);
          printf("stViFrameInfo.stVFrame.u64pts = %d\n",stViFrameInfo.stVFrame.u64pts );

          printf("stViFrameInfo.stVFrame.u16OffsetTop =%d\n",stViFrameInfo.stVFrame.u16OffsetTop);
          printf("stViFrameInfo.stVFrame.u16OffsetBottom = %d\n",stViFrameInfo.stVFrame.u16OffsetBottom);
          printf("stViFrameInfo.stVFrame.u16OffsetLeft = %d\n",stViFrameInfo.stVFrame.u16OffsetLeft);
          printf("stViFrameInfo.stVFrame.u16OffsetRight = %d\n",stViFrameInfo.stVFrame.u16OffsetRight);
          printf("stViFrameInfo.u32PoolId = %d\n",stViFrameInfo.u32PoolId);
          printf("stViFrameInfo.stVFrame.u32PhyAddr[0] = %#x\n",stViFrameInfo.stVFrame.u32PhyAddr[0]);
          printf("stViFrameInfo.stVFrame.u32PhyAddr[1] = %#x\n",stViFrameInfo.stVFrame.u32PhyAddr[1]);
          printf("stViFrameInfo.stVFrame.u32PhyAddr[2] = %#x\n",stViFrameInfo.stVFrame.u32PhyAddr[2]);
     
          printf("stViFrameInfo.stVFrame.pVirAddr[0] = %#x\n",stViFrameInfo.stVFrame.pVirAddr[0]);
          printf("stViFrameInfo.stVFrame.pVirAddr[1] = %#x\n",stViFrameInfo.stVFrame.pVirAddr[1]);
          printf("stViFrameInfo.stVFrame.pVirAddr[2] = %#x\n",stViFrameInfo.stVFrame.pVirAddr[2]);
#endif
